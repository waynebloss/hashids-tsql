...
BEGIN
	...
	DECLARE
		@salt varchar(255) = N'CE6E160F053C41518582EA36CE9383D5',
		@alphabet varchar(255) = N'NxBvP0nK7QgWmejLzwdA6apRV25lkOqo8MX1ZrbyGDE3',
		@seps varchar(255) = N'CuHciSFTtIfUhs',
		@guards varchar(255) = N'49JY',
		@minHashLength int = 0;
